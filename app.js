...
let DEFAULT_IMAGE = 'src/default.png';
let INITIAL_VALUE = 0;
let TYPE_OF_DIFFICULTIES = ['Easy'];
let TILE = [20];
let PATTERN = [5];
...
let MULTI3 = 2;
let getDefault;
let userInfo = { ID: ['test', 'adam', 'bernard'], password: ['1234', '2234', '3234'], cumScore: [0, 0, 0], cumPokemonID: [{ PokeID: [1, 4, 7] }, { PokeID: [1, 4, 7] }, { PokeID: [1, 4, 7] }] };
let interval;
let getPokemon;
let matchedAudio;
